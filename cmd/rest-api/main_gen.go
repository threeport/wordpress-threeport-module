...
import (
	...
	"net/http"
	"os"
	util "wordpress-threeport-module/cmd/rest-api/util"
	version "wordpress-threeport-module/internal/version"
	database "wordpress-threeport-module/pkg/api-server/v0/database"
	handlers_v0 "wordpress-threeport-module/pkg/api-server/v0/handlers"
	routes_v0 "wordpress-threeport-module/pkg/api-server/v0/routes"
	versions_v0 "wordpress-threeport-module/pkg/api-server/v0/versions"
)
...
func main() {
	...
	fmt.Printf("\nThreeport module REST API for API namespace lander2k2.com: %s\n", version.GetVersion())
